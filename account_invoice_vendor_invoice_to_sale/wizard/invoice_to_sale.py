...
class InvoiceToSale(models.TransientModel):
    ...
    analytic_distribution = fields.Boolean(
        string="Analytic distribution from the first line?",
        default=True,
    )
    ...
    def confirm(self):
        ...
        # Placeholder for analytic distribution
        ...
        if self.order_lines != "none":
            ...
            if self.order_lines == "copy":
                ...
                for line in invoice.invoice_line_ids:
                    # Use first line analytic distribution as order line distribution
                    if self.analytic_distribution and not analytic_distribution:
        ...
        if self.merge_order and sale_order:
            ...
            values = dict(
                ...
                fiscal_position_id=fp._get_fiscal_position(self.partner_id).id,
            )
