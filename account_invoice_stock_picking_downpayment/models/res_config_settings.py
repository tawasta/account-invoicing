...
class ResConfigSettings(models.TransientModel):
    ...
    @api.constrains('stock_picking_waiting_payment_priority', 'stock_picking_completed_payment_priority')
    def _check_stock_picking_priority(self):
        for record in self:
            ...
            try:
                ...
                raise ValidationError("Please use numeric values for picking priority")
