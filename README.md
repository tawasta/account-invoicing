...
[account_financial_report_amount_currency_error_fix](account_financial_report_amount_currency_error_fix/) | 14.0.1.0.0 |  | Fix for the amount_currency error
...
[account_invoice_commission_payment](account_invoice_commission_payment/) | 14.0.1.6.8 |  | Allows Making commission payments from invoices
...
[account_invoice_credit_note_header_text_and_date_delivered](account_invoice_credit_note_header_text_and_date_delivered/) | 14.0.1.0.0 |  | Copy Header and Date Delivered fields to a created Credit Note
...
[account_report_show_product](account_report_show_product/) | 14.0.1.0.1 |  | Always show product on invoice print lines
