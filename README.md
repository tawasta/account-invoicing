...
[account_invoice_commission_payment](account_invoice_commission_payment/) | 17.0.1.2.2 |  | Allows Making commission payments from invoices
...
[account_invoice_delivery_date_group](account_invoice_delivery_date_group/) | 17.0.1.1.1 |  | Some users can be added to a group to edit Delivery date
...
[account_move_line_delete_multiple](account_move_line_delete_multiple/) | 17.0.1.0.0 |  | Vendor Bills: Delete lines with checkboxes
[account_move_payment_link](account_move_payment_link/) | 17.0.1.0.4 |  | Autogenerates a payment link that can embedded into an email template
[account_move_uppercase_first_order](account_move_uppercase_first_order/) | 17.0.1.0.0 |  | Account move: Uppercase-first alphabetical order
